...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 6e26b32d-0510-49be-853e-e229716da650
```

> `6e26b32d-0510-49be-853e-e229716da650` is the password of the certificate, you can change it to any password you want.
